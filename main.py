...
for k in ipNets:
    ...
    print("------------------------")
    print("[" + colored("mapper.py", "yellow") + "][" + colored("PROGRESS", "yellow") + "]" + colored(
        str(progress / count * 100), "blue") + colored("%", "blue"))
    print("------------------------")
    time.sleep(5)
print("[" + colored("OK", "green") + "][" + colored("mapper.py", "yellow") + "] time taken for execution " + str(
